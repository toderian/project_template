...
- `playbooks/skills/grill-with-docs.md`
- `playbooks/skills/grill-with-docs/CONTEXT-FORMAT.md` (the glossary file format)
- `playbooks/skills/grill-with-docs/ADR-FORMAT.md` (the ADR file format)

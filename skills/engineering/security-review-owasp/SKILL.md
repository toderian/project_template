...
Use this skill for security reviews against current OWASP standards.

Read and follow:

- `playbooks/skills/engineering/security-review-owasp.md`
- `playbooks/skills/engineering/security-review-owasp/languages.md` (read only the section for the language you're reviewing)

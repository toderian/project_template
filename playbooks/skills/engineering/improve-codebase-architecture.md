...
description: "Explore a codebase to find opportunities for architectural improvement, focusing on making the codebase more testable by deepening shallow modules. Use when the user wants Codex to improve architecture, find refactoring opportunities, consolidate tightly-coupled modules, or make a codebase more AI-navigable."
---
...
- **Dependency category**: See `playbooks/skills/engineering/improve-codebase-architecture/REFERENCE.md` for the four categories
...
4. Dependency strategy (how deps are handled — see `playbooks/skills/engineering/improve-codebase-architecture/REFERENCE.md`)
5. Trade-offs
...
Create a refactor RFC as a GitHub issue using `gh issue create`. Use the template in `playbooks/skills/engineering/improve-codebase-architecture/REFERENCE.md`. Do NOT ask the user to review before creating — just create it and share the URL.

...
Vendored from [agamm/claude-code-owasp](https://github.com/agamm/claude-code-owasp) (MIT). Per-language quirks live in `playbooks/skills/security-review-owasp/languages.md` — read them only for the language you're reviewing.
...
For language-specific quirks (JS/TS, Python, Java, C#, PHP, Go, Ruby, Rust, Swift, Kotlin, C/C++, Scala, R, Perl, Shell, Lua, Elixir, Dart/Flutter, PowerShell, SQL), read `playbooks/skills/security-review-owasp/languages.md`. Read only the section for the language you're reviewing.

...
- [AGENT-BRIEF.md](github-triage/AGENT-BRIEF.md) — how to write durable agent briefs
- [OUT-OF-SCOPE.md](github-triage/OUT-OF-SCOPE.md) — how the `.out-of-scope/` knowledge base works
...
- **ready-for-agent** — post an agent brief comment (see [AGENT-BRIEF.md](github-triage/AGENT-BRIEF.md))
...
- **wontfix (enhancement)** — write to `.out-of-scope/`, post a comment linking to it, then close the issue (see [OUT-OF-SCOPE.md](github-triage/OUT-OF-SCOPE.md))

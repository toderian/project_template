...
argument-hint: "Which raw docs, files, or pasted context should I distill?"
metadata:
  source: playbooks/skills/engineering/distill-knowledge.md
  pack: docs-knowledge
---
...
batch folder per source event. Use assets/resource-inbox-batch.template.md for the
...
- append or update one row in `docs/resources/<area>/sources.md` using
  assets/area-sources.template.md when an area receives teammate input, a call batch,

---
name: workbook
description: "Layout, README shape, and script conventions for reusable workbook bundles under workbooks/<workbook-slug>/, including prompt-orchestration workbooks. Use when creating, organizing, or reviewing a workbook, or deciding whether a body of work belongs in workbooks/ versus docs/resources/."
metadata:
  source: playbooks/conventions/workbook-convention.md
paths: ["workbooks/**"]
---

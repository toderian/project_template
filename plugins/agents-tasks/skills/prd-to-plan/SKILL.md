...
Break the PRD into **tracer bullet** phases. Each phase is a thin vertical slice that cuts through ALL integration layers end-to-end, NOT a horizontal slice of one layer. Follow the slice rules in [references/vertical-slicing.md](references/vertical-slicing.md).

...
description: "Review multiple linked pull requests as one cross-repo feature: contracts, rollout order, compatibility, CI, and per-PR risks. Use when the user says \"cross-repo PR review\", \"review these PRs together\", \"multi-repo PRs\", or asks to validate PRs across repos."
metadata:

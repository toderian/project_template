...
- Learn the domain language used in that area (check `docs/resources/CONTEXT.md`)
...
- **Use the project's domain language** (check `docs/resources/CONTEXT.md` if it exists)

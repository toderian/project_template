...
metadata:
  source:
    ...
    - playbooks/skills/engineering/zoom-out.md
  pack: architecture
---
...
This skill produces a map. It does not propose changes, write code, or critique the design. If the map surfaces a real architectural problem, mention it under "Open questions" and let the user decide whether to follow up with `agents-extras:improve-codebase-architecture` or `agents-core:diagnose`.

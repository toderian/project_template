...
- **ready-for-agent** — post an agent brief comment (see [AGENT-BRIEF.md](references/AGENT-BRIEF.md))
...
- **wontfix (enhancement)** — write to `.out-of-scope/`, post a comment linking to it, then close the issue (see [OUT-OF-SCOPE.md](references/OUT-OF-SCOPE.md))

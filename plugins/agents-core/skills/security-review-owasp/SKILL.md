...
description: "Apply current OWASP standards (Top 10, ASVS, LLM Top 10, Agentic AI) when writing or reviewing code. Use when reviewing code for security issues, implementing auth/authz, handling user input, designing API endpoints, building AI agent systems, or integrating LLMs/RAG."
metadata:
  source: playbooks/skills/engineering/security-review-owasp.md
  pack: security
---

---
name: execute-plan
description: "Execute an approved task or implementation plan phase-by-phase, committing each phase and running independent reviews. Use when the user says \"execute plan\" / \"/execute-plan\", or points to docs/tasks_manager/_todos/<TASK>.md or docs/_plans/<slug>.md and wants it implemented."

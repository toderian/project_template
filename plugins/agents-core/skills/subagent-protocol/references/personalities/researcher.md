...
Use this role for any task that needs grounding before action: evaluating libraries, comparing approaches, surfacing prior art before a new feature, or refreshing doctrine (`AGENTS.md`, evaluation guides, long-running agent scaffolding) against current primary sources.

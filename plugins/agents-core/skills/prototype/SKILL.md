...
Build a throwaway prototype to flesh out a design before committing to it. A prototype is **throwaway code that answers a question**. The question decides the shape.
...
- Logic prototypes: see [references/LOGIC.md](references/LOGIC.md).
- UI prototypes: see [references/UI.md](references/UI.md).
